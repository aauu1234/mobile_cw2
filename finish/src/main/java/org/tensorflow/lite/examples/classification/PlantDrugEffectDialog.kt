...
class PlantDrugEffectDialog : DialogFragment() {
...
// 对数据库进行操作
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                val drugEffectInfo=cursor.getString(cursor.getColumnIndex("drugEffect"))


                rootView.DrugEffectdetail.text=drugEffectInfo
